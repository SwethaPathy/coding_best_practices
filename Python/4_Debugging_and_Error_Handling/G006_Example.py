...
def process_order(order_data):
    try:
        ...
        if order["quantity"] == 0:
            ...
            )  # Custom exception is used appropriately for business logic validation.
        ...
        )  # Logs the complete stack trace for better diagnosis.


# Simulating an invalid order input
process_order(
    '{"order_id": 123, "total_price": 100, "quantity": 0}'
)  # This will trigger a custom exception (quantity == 0)
